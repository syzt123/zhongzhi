    ...
    <form class="layui-form" action="" id="addLandForm">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="v_type" value="{{$vegetableType->v_type}}" autocomplete="off"
                       lay-verify="required" lay-reqtext="名称是必填项，岂能为空？"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="number" name="v_price" value="{{$vegetableType->v_price}}" lay-verify="required"
                       lay-reqtext="认领价格是必填项，岂能为空？"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="number" name="f_price" value="{{$vegetableType->f_price}}" lay-verify="required"
                       lay-reqtext="蔬菜币是必填项，岂能为空？"
                       placeholder="请输入" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
